...
## Language Concepts
Bop is a stack-based programming language, as everything revolves around a central stack that is initially empty. Programs in Bop are created by first running the corresponding Java program (Bop.java), which opens a window in which your inputs will be entered. Accepted inputs are as follows:
- Spacebar
